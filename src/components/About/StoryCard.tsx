    ...
    <div className="">
      <div className="grid grid-cols-2 mt-32 max-w-4xl mx-auto max-md:grid-cols-1" data-aos="fade-left"
        ...
        <div className="ml-10 inline-block max-w-2xl text-blue-500 max-md:ml-0">
          ...
          <p className="mt-10 font-monserrat text-gray-500 max-md:w-96 max-md:mx-auto max-md:text-md">
      ...
      <div className="grid grid-cols-2 mt-32 max-w-4xl mx-auto max-md:grid-cols-1" data-aos="fade-right"
        data-aos-duration="1000">
        ...
        <img src={headshot2} className="h-96 ml-48 rounded drop-shadow-2xl pointer-events-none max-md:mx-auto" />
      </div>
      <div className="grid grid-cols-2 mt-32 max-w-4xl mx-auto max-md:grid-cols-1" data-aos="fade-left"
        data-aos-duration="1000"> 
        <img src={headshot3} className="h-96 mr-10 rounded drop-shadow-2xl pointer-events-none max-md:mx-auto" />
        <div className="ml-10 inline-block max-w-2xl text-blue-500 max-md:ml-0">
